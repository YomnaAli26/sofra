            ...
            <div class="row">
                div class="col-md-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <!-- Print Entire Order Section -->
                            <button onclick="printOrderDetails()" class="btn btn-primary">Print Order Details</button>
...
@push('scripts')
    <script>
        function printOrderDetails() {
            const printableContent = document.getElementById('orderDetailsSection').outerHTML;
            ...
            // Reload the page to reinitialize JavaScript events
