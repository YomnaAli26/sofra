<nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
    <div class="container-fluid"> <!--begin::Start Navbar Links-->
        ...
        <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
            <li class="nav-item"> <a class="nav-link" data-widget="navbar-search" href="{{ route("admin.locals.toggle",app()->getLocale()) }}" role="button"> {{ ucfirst(app()->getLocale()) }} </a> </li> <!--end::Navbar Search--> <!--begin::Messages Dropdown Menu-->
